...
addprocs(40)
@everywhere include("/home/gautham/ThreeLevelQuantumEngine/RedfieldParameterSweep/RedfieldThreeLevelEngine.jl")
...
@time @sync @distributed for (βh, offset) in collect(IterTools.product(β_arr, offset_arr))
    filename = "/home/gautham/ThreeLevelQuantumEngine/RedfieldOffset/TimeEvolData/OffsetEngine_ω_$(ω)_β_$(βh)_g_$(g)_δ_$(δ)_off_$(offset).jld2"
    if !isfile(filename)
        ...
        ergotropy_rate, energy_rate, means, variances, Qh, Qc, t = main(
            ...
            savePlots=true, 
            savePlotsAt="/home/gautham/ThreeLevelQuantumEngine/RedfieldOffset/Figures/"
        )
        # save the data
